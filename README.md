...
Optional (not required for the assignment): a script `build_backprop_sheet.py` was used during development to prototype a **Back Propagation** sheet; it is **not** part of the current workbook. You can add backprop in a future version if your course requires it.
